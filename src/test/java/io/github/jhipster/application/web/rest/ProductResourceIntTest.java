...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getManuId()).isEqualTo(DEFAULT_MANU_ID);
        assertThat(testProduct.getManuName()).isEqualTo(DEFAULT_MANU_NAME);
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getManuId()).isEqualTo(UPDATED_MANU_ID);
        assertThat(testProduct.getManuName()).isEqualTo(UPDATED_MANU_NAME);
